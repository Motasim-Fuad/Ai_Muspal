...
class ViolinAnalysisView extends StatefulWidget {
  const ViolinAnalysisView({super.key});

  @override
  State<ViolinAnalysisView> createState() => _ViolinAnalysisViewState();
}

class _ViolinAnalysisViewState extends State<ViolinAnalysisView> {
  @override
